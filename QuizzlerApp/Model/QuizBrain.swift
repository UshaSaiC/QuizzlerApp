...
struct QuizBrain{
    ...
    func getFirstOptionText() -> String{
        return quizQuestions[questionNumber].answer[0]
    }
    
    func getSecondOptionText() -> String{
        return quizQuestions[questionNumber].answer[1]
    }
    
    func getThirdOptionText() -> String{
        return quizQuestions[questionNumber].answer[2]
    }
